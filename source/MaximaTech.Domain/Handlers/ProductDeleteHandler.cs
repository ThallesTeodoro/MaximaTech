...
{
    public class ProductDeleteHandler : IRequestHandler<ProductDeleteRequest, object>
    {
        ...
        public ProductDeleteHandler(IUnitOfWork uow)
        {
            _uow = uow;
        }
        ...
        public async Task<object> Handle(ProductDeleteRequest request, CancellationToken cancellationToken)
        {
